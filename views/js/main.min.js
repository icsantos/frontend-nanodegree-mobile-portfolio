...
window.addEventListener('scroll',updatePositions);document.addEventListener('DOMContentLoaded',function(){var cols=8,s=256,pizzaCount=Math.round(window.innerHeight/s)*cols,elemParent=document.getElementById("movingPizzas1"),elem,i;for(i=0;i<pizzaCount;i++){elem=document.createElement('img');elem.className='mover';elem.src="images/pizza_74.png";elem.style.height="96px";elem.style.width="74px";elem.basicLeft=(i%cols)*s;elem.style.top=(Math.floor(i/cols)*s)+'px';elemParent.appendChild(elem);}
updatePositions();});