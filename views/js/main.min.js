...
function updatePositions(){frame++;window.performance.mark("mark_start_frame");var allMovers=document.getElementsByClassName("mover"),allMoversLength=allMovers.length,scrollTop=document.body.scrollTop/1250;var phases=[],phase,maxPos=5,i;for(i=0;i<maxPos;i++){phases.push(Math.sin(scrollTop+(i%maxPos))*(i%8)*256);}
for(i=0;i<allMoversLength;i++){allMovers[i].style.transform='translateX('+phases[i%5]+'px)';}
